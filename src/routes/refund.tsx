  ...
  return (
    <LegalLayout title="Refund Policy" updated="May 11, 2026">
      ...
      <p>
        ...
        which is used to place orders with upstream providers. This policy explains when refunds
        are issued.
      </p>

      <h2>Wallet Deposits</h2>
      <p>
        <strong>Wallet deposits are non-refundable to the original payment method.</strong> This applies to:
      </p>
      <ul>
      ...
      <p>
        Once funds are credited to your platform balance, they are usable for any service on
        Boostan but cannot be converted back to your original payment method.
      </p>

      <h2>Orders That Cannot Be Refunded</h2>
      <p>The following situations do <strong>not</strong> qualify for refunds:</p>
      <ul>
        <li>Orders that completed successfully as ordered</li>
        <li>Orders that delivered 80% or more of the requested quantity</li>
        <li>Orders affected by third-party platform actions (Instagram, TikTok, YouTube removing engagement)</li>
      ...
      <p>The following situations qualify for <strong>wallet credit refunds</strong> (not original payment method):</p>
      <ul>
        <li>Orders that failed entirely (0% delivered)</li>
        <li>Orders that delivered less than 80% of the requested quantity, refunded proportionally</li>
      ...
      <p>Refunds are processed within 48 hours of verification and credited to your platform wallet.</p>

      <h2>How to Request a Refund</h2>
      <p>
        Email <a href="mailto:hello@boostan.co">hello@boostan.co</a> within 14 days of the order with:
      </p>
      <ul>
      ...
      <p>
        We review each request individually. Approved refunds are credited as wallet balance. We
