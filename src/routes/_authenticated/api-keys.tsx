  ...
  return (
    <div className="space-y-8">
      <header>
        ...
        <h1 className="mt-1 text-3xl md:text-4xl">API <span className="gradient-text">access</span></h1>
        <p className="mt-2 text-sm text-foreground-muted">Automate your reseller pipeline with our v2 REST API.</p>
      </header>
      ...
      <div className="glass rounded-2xl p-6">
        ...
        <div className="mt-3 flex items-center gap-2 rounded-lg bg-[var(--surface)] px-4 py-3 font-mono text-sm">
          ...
          <button onClick={() => copy(apiKey)} className="text-foreground-muted hover:text-foreground"><Copy className="h-4 w-4" /></button>
        </div>
        <p className="mt-3 text-xs text-foreground-subtle">Test key — production keys appear after KYC.</p>
      </div>
      ...
      <div className="glass rounded-2xl p-6">
        ...
        <div className="mt-3 flex items-center gap-2 rounded-lg bg-[var(--surface)] px-4 py-3 font-mono text-sm">
          ...
          <button onClick={() => copy(endpoint)} className="text-foreground-muted hover:text-foreground"><Copy className="h-4 w-4" /></button>
        </div>
      </div>

      <div className="glass overflow-hidden rounded-2xl">
        <div className="border-b border-[var(--border)] px-6 py-4 text-sm uppercase tracking-wider text-foreground-subtle">Quick example</div>
