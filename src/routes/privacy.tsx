...
function PrivacyPage() {
  return (
    <LegalLayout title="Privacy Policy" updated="May 11, 2026">
      ...
      <p>
        This Privacy Policy describes how {BUSINESS.brand} ("we", "us", "our"), operated by{" "}
        {BUSINESS.legalName}, a corporation registered in {BUSINESS.jurisdiction}, collects, uses,
        and protects information when you use the Service.
      </p>
