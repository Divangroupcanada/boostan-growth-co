...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-dcjbtOYW.mjs");
...
const manifest = {
  "1d8f124e3efcbf67e658a83cead1bf8f9c4d742b5bdbfc2913de523c02caad60": {
    functionName: "placeOrder_createServerFn_handler",
    importer: () => import("./smmflw.functions-D5aGPw4u.mjs")
  },
  "2cc2529d722680413988547990e4c5c27cb45c7d102e265dcf9694a3425e006e": {
    functionName: "syncServices_createServerFn_handler",
    importer: () => import("./smmflw.functions-D5aGPw4u.mjs")
  },
  "2e84c9bf2439f492f741fe95523f277c6fc04a6ad007e6b81bd306620b13d349": {
    functionName: "triggerTestWebhook_createServerFn_handler",
    importer: () => import("./nowpayments.functions-dif9EgQV.mjs")
  },
  "51ba010ccb741c6348eb23d0012a0894698d5ef8567f1c9c2df174896404676c": {
    functionName: "adminConfirmManualDeposit_createServerFn_handler",
    importer: () => import("./nowpayments.functions-dif9EgQV.mjs")
  },
  "8f7b989abb69a2670f2232bff153b37987b8b8e96d0eea38f9da4be4d63d45b2": {
    functionName: "markManualEtransfer_createServerFn_handler",
    importer: () => import("./nowpayments.functions-dif9EgQV.mjs")
  },
  "a3f46637b482306e515f028fc8375ca1977ca5077bfacbbed17a1163376c7935": {
    functionName: "createDeposit_createServerFn_handler",
    importer: () => import("./nowpayments.functions-dif9EgQV.mjs")
  },
  "da19624aa9037b62b7745093213038a00932614bf2baee2d83619ab6b881f798": {
    functionName: "getProviderBalance_createServerFn_handler",
    importer: () => import("./smmflw.functions-D5aGPw4u.mjs")
  },
  "dc7921b24945922cdae72dcca24b37c9128e5d2247423f5fbb424911be35e784": {
    functionName: "listWebhookLogs_createServerFn_handler",
    importer: () => import("./nowpayments.functions-dif9EgQV.mjs")
  },
  "e1af295702a143ff2280038af37c51808bb42db2ac786d065b5c9cbb861ac748": {
    functionName: "checkDepositStatus_createServerFn_handler",
    importer: () => import("./nowpayments.functions-dif9EgQV.mjs")
  },
  "f60f79903a085a8aefc4c1ce566953f1a3714f695dd67625718bc704358bd59b": {
    functionName: "checkOrderStatus_createServerFn_handler",
    importer: () => import("./smmflw.functions-D5aGPw4u.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-Db83cYJW.mjs").then((n) => n.r),
    import("./start-CnTC8h0H.mjs"),
